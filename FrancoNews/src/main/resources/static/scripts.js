...
// Manejar el envío del formulario para actualizar una noticia
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        registerForm.addEventListener('submit', function(event) {
            ...
            // Envía estos datos al backend para el registro
            registerUser({ email, password, name, lastName, country, role });
        });
        ...
        loginForm.addEventListener('submit', function(event) {
            ...
            // Envía estos datos al backend para iniciar sesión
        ...
        function registerUser(userData) {
            fetch('/auth/register', {
                ...
                .then(response => response.json())
                .then(responseData => {
                    // Manejar la respuesta del backend, redireccionar o mostrar mensaje, etc.
                })
                .catch(error => console.error('Error registering user:', error));
        }

        // Función para enviar datos de inicio de sesión al backend
